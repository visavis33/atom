...
close:function(){this.unbindEvents();a.isFunction(this.o.onClose)&&this.o.onClose.apply(this,[this.d]);this.d.modal.hide().remove();this.d.mask.hide().remove();this.d={};(f=0<c.length?!0:!1)&&c.shift()()}}})(jQuery);